...
const AssetInjections: IInjectedField[] = [
    Faker.injectedTextField('id'),
    Faker.injectedTextField('title'),
    Faker.injectedTextField('path'),
    Faker.injectedTextField('filename'),
    Faker.injectedTextField('basename'),
    Faker.injectedTextField('extension'),
