...
const StringConditionItems: ICompletionCondition[] = [
	...
	{ name: 'isnt', description: 'Tests if a field is not equal to a valeu' },
	...
	{ name: 'is_alpha_numeric', description: 'Tests if a field contains onlky alpha-numeric characters' },
