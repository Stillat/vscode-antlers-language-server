...
export function getFormatOption(options: IHTMLFormatConfiguration, key: keyof IHTMLFormatConfiguration, dflt: any): any {
...
export function getTagsFormatOption(options: IHTMLFormatConfiguration, key: keyof IHTMLFormatConfiguration, dflt: string[] | undefined): string[] | undefined {
...
export function getTemplatingFormatOption(options: IHTMLFormatConfiguration, dflt: string): ('auto' | 'none' | 'django' | 'erb' | 'handlebars' | 'php')[] | undefined {
