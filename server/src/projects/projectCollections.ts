...
import { ICollection, IStructure } from './statamicProject';

export function getCollectionDetails(collectionPath: string): ICollection {
	const handle = path.basename(collectionPath).split('.').slice(0, -1).join('.'),
	...
	try {
		...
		if (typeof document !== 'undefined' && document !== null) {
			...
			if (typeof document.template !== 'undefined' && document.template !== null) {
			...
			if (typeof document.taxonomies !== 'undefined' && document.taxonomies !== null) {
				taxonomyNames = Object.keys(document.taxonomies);
			}

			if (typeof document.structure !== 'undefined' && document.structure !== null) {
				isStructure = true;
				...
				if (typeof tempStructure.root !== 'undefined' && tempStructure.root !== null) {
					root = tempStructure.root;
				}

				if (typeof tempStructure.max_depth !== 'undefined' && tempStructure.max_depth !== null) {
